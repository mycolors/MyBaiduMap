...
public class BaiduNaviActivity extends Activity {
    ...
    private final String TAG = BaiduNaviActivity.class.getName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent != null) {
            ...
            if (bundle != null) {
                mBNRoutePlanNode = (BNRoutePlanNode) bundle.getSerializable("data");
            }
        }
        //显示自定义图标
        if (hd != null) {
    ...
    private void addCustomizedLayerItems() {
        ...
        if (mBNRoutePlanNode != null) {
            item1 = new CustomizedLayerItem(mBNRoutePlanNode.getLongitude(), mBNRoutePlanNode.getLatitude(),
                    mBNRoutePlanNode.getCoordinateType(), getResources().getDrawable(R.drawable.icon_my_location),
